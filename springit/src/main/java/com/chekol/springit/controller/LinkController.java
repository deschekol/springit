...
import com.chekol.springit.SpringitApplication;
...
public class LinkController {
	...
	public void LinkRepository(LinkRepository linkRepository) {
    ...
    public String read(@PathVariable Long id,Model model) {
        ...
        if( link.isPresent() ) {
            ...
            model.addAttribute("success", model.containsAttribute("support"));
            return "link/view";
        } else {
            return "redirect:/";
        }
